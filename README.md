...
Optionally (besides `txjson`) a payload can contain these properties ([PY definition](https://github.com/CASL-AE/xumm-sdk-py/blob/master/xumm/resource/types/xumm_api/__init__.py#L898)):
